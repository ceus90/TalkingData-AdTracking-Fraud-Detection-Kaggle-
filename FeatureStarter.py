...
def read_train_test():
    ...
    ape = pd.read_csv("~/Downloads/app_events.csv")
    ...
    # Events
    print('Read events...')
    events = pd.read_csv("~/Downloads/events.csv", dtype={'device_id': np.str})
    ...
    # Phone brand
    print('Read brands...')
    pbd = pd.read_csv("~/Downloads/phone_brand_device_model.csv", dtype={'device_id': np.str})
    ...
    # Train
    print('Read train...')
    train = pd.read_csv("~/Downloads/gender_age_train.csv", dtype={'device_id': np.str})
    ...
    # Test
    print('Read test...')
    test = pd.read_csv("~/Downloads/gender_age_test.csv", dtype={'device_id': np.str})
